...
import { Awaitable, ChatInputCommandInteraction, BaseInteraction, MessageEditOptions, MessagePayload, APISelectMenuOption, InteractionReplyOptions } from 'discord.js';
...
interface SelectMenuConfirmationOptions extends APISelectMenuOption {
    disabled?: boolean;
	message: string | MessagePayload | MessageEditOptions;
}

interface SelectMenuConfirmationEvents {
	confirmed: [sent: BaseInteraction<boolean>, selected: string[]]
	expired: [sent: BaseInteraction<boolean>, error: Error]
}
